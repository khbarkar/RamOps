...
echo "=== RamOps: Kafka Network-Bound Brokers (Kind) ==="
echo ""
...
echo ""
echo "  Kafka brokers throttled to 50 Mbit/s"
echo "  Network bandwidth is saturated"
echo ""
echo "  Debug with:"
echo "    kubectl get pods -n kafka"
echo "    kubectl exec -n kafka kafka-0 -- tc qdisc show"
echo "============================================"
